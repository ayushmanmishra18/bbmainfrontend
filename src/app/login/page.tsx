    ...
    <div className="min-h-screen bg-subtle dark:bg-gray-900 flex flex-col justify-center items-center p-4">
      <Card className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <button type="submit" disabled={isLoading} className="w-full px-8 py-3 bg-blue-600 text-white font-bold rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:bg-gray-400 transition-colors">
        ...
        <p className="text-center text-sm text-gray-500 mt-8">
          ...
          <Link href="/register" className="font-medium text-blue-600 hover:underline">Register here</Link>
        </p>
      </Card>
    </div>
  );
